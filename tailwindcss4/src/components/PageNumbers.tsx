...
const PageNumber = () => {
    ...
    const [pageNumberFormat, setPageNumberFormat] = useState<string>('1');
    ...
    const handleAddPageNumbers = async (e: FormEvent) => {
        e.preventDefault();
        ...
        try {
            ...
            const res = await axios.post(
                `${import.meta.env.VITE_API_URL}/page-numbers`,
                formData,
                {
            ...
            setStatus({ loading: false, error: "Failed to add page numbers. Please try again." });
        }
    };

    return (
        <div className="max-w-4xl mx-auto mt-8 p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-xl">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 text-center">Add Page Numbers to PDF</h1>

            <div className="text-gray-600 dark:text-gray-300 mb-8 text-center">
                Add page numbers to your PDF document to make it easier to navigate.
            </div>

            <form onSubmit={handleAddPageNumbers} className="space-y-6">
                {/* File Upload */}
                <div>
                ...
                <div>
                    ...
                    <select
                        ...
                        onChange={(e: ChangeEvent<HTMLSelectElement>) => setPageNumberFormat(e.target.value)}
            ...
            <div className="mt-12 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl border border-blue-100 dark:border-blue-800/30">
                ...
                <ol className="list-decimal list-inside space-y-2 text-blue-700 dark:text-blue-300">
                    ...
                    <li>Select the desired page number format (e.g., 1, i, A).</li>
                    <li>Click the "Add Page Numbers" button.</li>
                    <li>Once the process is complete, a download link will appear. Click it to download your page-numbered PDF file.</li>
                </ol>
            </div>
        </div>
    );
