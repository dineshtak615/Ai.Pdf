...
import { FaFilePdf, FaSpinner, FaTimes, FaDownload, FaCloudUploadAlt, FaInfoCircle, FaImage, FaFont, FaCog } from 'react-icons/fa';
...
const EditPDF = () => {
    ...
    const handleEditOptionChange = (option: keyof EditOptions, value: string | number | boolean) => {
        setEditOptions(prev => ({
            ...prev,
            [option]: value
        }));
    ...
    const handleImageChange = (e: ChangeEvent<HTMLInputElement>) => {
        if (e.target.files && e.target.files[0]) {
            ...
            setEditOptions(prev => ({ ...prev, addImage: imageFile }));
        }
    };
    ...
    const handleEdit = async (e: FormEvent) => {
        ...
        if (editOptions.addImage) {
            formData.append("image", editOptions.addImage);
        }
        ...
        try {
            ...
            const response = await axios.post(
                `${import.meta.env.VITE_API_URL}/edit-pdf`,
                formData,
                {
            ...
            setStatus({ loading: false, error: "Failed to edit PDF. Please try again." });
        }
    };

    return (
        <div className="max-w-4xl mx-auto mt-8 p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-xl">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 text-center">Edit PDF</h1>

            <div className="text-gray-600 dark:text-gray-300 mb-8 text-center">
                Add text, images, watermarks, rotate pages, and more to your PDF document.
            </div>
            ...
            <form onSubmit={handleEdit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={editOptions.addText}
                            onChange={(e) => handleEditOptionChange('addText', e.target.value)}
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => handleEditOptionChange('rotate', parseInt(e.target.value))}
                            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white"
                        >
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={editOptions.watermark}
                            onChange={(e) => handleEditOptionChange('watermark', e.target.value)}
                    ...
                    <div>
                        ...
                        <label
                            ...
                            className="relative cursor-pointer bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl shadow-sm py-3 px-4 block w-full text-sm text-gray-500 dark:text-gray-400 text-center hover:bg-gray-100 dark:hover:bg-gray-700"
                        >
                            {editOptions.addImage ? editOptions.addImage.name : "Choose an Image"}
                        </label>
                    </div>
                </div>
                ...
                <div className="flex items-center">
                    <input
                        type="checkbox"
                        id="pageNumbers"
                        checked={editOptions.pageNumbers}
                        onChange={(e) => handleEditOptionChange('pageNumbers', e.target.checked)}
                        className="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="pageNumbers" className="ml-2 block text-sm text-gray-900 dark:text-gray-300">
                        Add Page Numbers
                    </label>
                </div>
            ...
            <div className="mt-12 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl border border-blue-100 dark:border-blue-800/30">
                ...
                <ol className="list-decimal list-inside space-y-2 text-blue-700 dark:text-blue-300">
                    ...
                    <li>Choose your desired edit options, such as adding text, image, watermark, rotating pages, or adding page numbers.</li>
                    <li>Click the "Edit PDF" button.</li>
                    <li>Once the editing is complete, a download link will appear. Click it to download your edited PDF file.</li>
                </ol>
            </div>
        </div>
    );
